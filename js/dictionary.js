...
featureDictionary['talkback'] = { featureLogo: './img/whatsup.png', featureName: 'מה קורה' };
featureDictionary['channel'] = { featureLogo: './img/youtube.png', featureName: 'יוטיוב' };
featureDictionary['facebookBennet'] = { featureLogo: './img/NaftaliBennett.png', featureName: 'פייסבוק נפתלי' };
...
featureDictionary['meme'] = { featureLogo: './img/meme.png', featureName: 'צחוקים' };
featureDictionary['event'] = { featureLogo: './img/calendar.png', featureName: 'נפגשים' };
