...
function HeDate(p1,p2,p3){
    ...
    if (typeof(p1) == "number" && typeof(p2) == "number" && typeof(p3) == "number"){
    	...
    	this.setTime(p1);
    else if ((typeof(p1) == "object") && (p1.constructor == HeDate) && typeof(p2) == "undefined" && typeof(p3) == "undefined"){ // copy constructor
		...
		var GregDate
		if ((typeof(p1) == "object") && (p1.constructor == Date) && typeof(p2) == "undefined" && typeof(p3) == "undefined") //convert constructor
			GregDate=new Date(p1);
